		...
		<div class="nav-wrapper">
			<div class="topLeft">
				...
				<div class="topLeft__icons">
			      	<a href="http://twitter.com/joshsalyer23"><img class="social_icon" alt="Twitter Logo" src="../img/twitter_256.png" width= "60px" height= "60px"></a>

			      	<a href="http://facebook.com/joshsalyer23"><img class="social_icon" alt="Facebook Logo" src="../img/facebook_black.png" width= "60px" height= "60px"></a>

			      	<a href="http://github.com/jsalyer23"><img class="social_icon" alt="GitHub Logo" src="../img/GitHub-Mark-64px.png" width= "60px" height= "60px"></a>
			     </div>
			</div>
			...
			<ul class="nav">
					...
					<li class="navTitles__page">
						<div class="navLinks" <?php if ($thisPage == "Front-end VS Back-end") {echo " id=\"current_page\"";} ?>>	
