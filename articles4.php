...
?>
				...
				<p>Every HTML document starts by declaring the _______!DOCTYPE html____. If you don't tell the browser how to interperet your HTML doument it won't know what to do with it. The second tag needed to start an HTML document is the _____html____ tags which surround everything besides the doctype decloration. The _____html___ tags also tell the browser that everything within them should be _interpereted_ as HTML script.</p>

				<p>Within the ___html___ tags are the head, body, and footer. The head tags come before the body and include all of the head elements. Elements within the head tags could include ____title___(adds a title to your webpage and is also required for a valid HTML document), ____style___(contains CSS directly within your HTML document), ___link___(links other files with the current file), ____script___(adds JavaScript into your HTML document), or ____meta__ tags(provide meta data about the HTML document).</p>
