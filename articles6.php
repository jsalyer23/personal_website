...
?>
				...
				<p><strong>HTTP</strong> - Hypertext transfer protocol is an application that handles the interpretation of HTML documents for the World Wide Web.</p>

				<p><strong>Server</strong> - A computer that handles requests from clients by returning the data requested. The server contains the HTML files that make up the website requested.</p>

				<p><strong>Client</strong> - The device that is requesting a web page from the server or some other type of data. The device could be anything that has access to the internet.</p>
